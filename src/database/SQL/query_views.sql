...
SELECT HF.id_factura, HF.id_orden, OC.fecha_compra, HF.productos, u1.nombre 'Nombre vendedor', u2.nombre 'Nombre cliente'
FROM (HISTORICO_FACTURAS as HF, ORDENES_COMPRA as OC)
