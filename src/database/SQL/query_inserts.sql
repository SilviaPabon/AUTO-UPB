...
(3, 3,"Cubierta negra para carro","Cubierta de tela negra impermeable para carros. Permite prevenir daños por rayos UV, polvo, nieve, escarcha, lluvia, etc. Se incluye estuche para guardar la cubierta. ",40, 220000, 320000,25,240000,"/Cubierta_negra_para_carro.jpg"),
...
(3, 3,"Asiento pequeño para bebé","Silla de poliéster acolchada para bebés. Permite a los bebés descansar de manera segura y cómoda en el viaje. Peso máximo recomendado de 30Kg. La silla es fácil de transportar y trasladar gracias a su tamaño y peso.",15, 240000,360000,15,306000,"/Asiento_pequeño_para_bebé.jpg"),
