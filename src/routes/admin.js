...
router.post('/inventory/add_new', controller.inventory_add_new_post); 
...
router.post('/accounts', controller.searchAccounts); 
router.get('/accounts/:criteria', controller.searchAccountsResult)
